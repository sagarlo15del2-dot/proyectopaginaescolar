            ...
            <div class="contacto-form-section">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="contacto-btn-wrapper">
                        <button type="submit" class="btn-enviar-rojo">Enviar Mensaje</button>
                        <p class="campos-obligatorios-txt">Campos obligatorios (*)</p>
                    </div>
                </form>
            </div>

            <div class="contacto-info-section">
                <h3 class="contacto-info-titulo">Atención Directa</h3>
                ...
                <ul class="contacto-lista-detalles">
                    ...
                    <li class="contacto-lista-item">
                        <div class="contacto-icono-circulo"><i class="fa-solid fa-calendar-days"></i></div>
                ...
                <div class="contacto-mapa-caja">
                    <img src="https://via.placeholder.com/400x200?text=Mapa+de+Ubicación" alt="Mapa de la escuela">
                </div>
                <a href="#" class="contacto-link-mapa">Encuéntranos Aquí (Abrir en Google Maps)</a>
            </div>
